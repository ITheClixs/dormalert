...
def load_settings(env_file: str | Path = ".env") -> AppConfig:
    ...
    return AppConfig(
        ...
        notification=NotificationSettings(
            ...
            wa_cloud_enabled=get_bool("DORMALERT_WA_CLOUD_ENABLED", False),
            wa_cloud_token=os.environ.get("DORMALERT_WA_CLOUD_TOKEN") or None,
            wa_cloud_phone_number_id=os.environ.get("DORMALERT_WA_CLOUD_PHONE_NUMBER_ID") or None,
            wa_cloud_to=os.environ.get("DORMALERT_WA_CLOUD_TO") or None,
            wa_cloud_template=os.environ.get("DORMALERT_WA_CLOUD_TEMPLATE") or "dormalert_alert",
            wa_cloud_template_lang=os.environ.get("DORMALERT_WA_CLOUD_TEMPLATE_LANG") or "en",
            wa_cloud_timeout_seconds=get_int("DORMALERT_WA_CLOUD_TIMEOUT_SECONDS", 15),
